<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.name" clearable class="filter-item" style="width: 110px;" placeholder="活动名称"/>
      ...
      <el-select v-model="listQuery.orderStatusArray" multiple style="width: 110px" class="filter-item" placeholder="订单状态">
      ...
      <el-button v-permission="['GET /admin/grouponorders/list']" class="filter-item" type="primary" icon="el-icon-search" @click="handleFilter">查找</el-button>
      <el-button
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="团购价" prop="grouponPrice"/>
...
<script>
import { listGrouponOrders,createGrouponOrder,deleteGrouponOrder,editGrouponOrder } from '@/api/grouponorder'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listGrouponOrders(this.listQuery).then(response => {
    ...
    handleDownload() {
      ...
      listGrouponOrders(this.listQuery)
        .then(response => {
          ...
          import('@/vendor/Export2Excel').then(excel => {
            ...
            const filterVal = ['name', 'userNickname', 'orderId', 'orderSn','userPhone', 'addTime', 'goodsSn', 'goodsName', 'goodsProductSpecifications',
              'sourcePrice','grouponPrice', 'beginDate', 'expireTime']
