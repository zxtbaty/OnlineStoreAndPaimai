  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :close-on-click-modal="false" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon  label-width="100px" >
        ...
        <el-form-item label="广告图片(694*430)" prop="url">
          <el-upload
            :headers="headers"
            :action="uploadPath"
        ...
        <el-form-item label="广告位置" prop="position">
          <el-select clearable v-model="dataForm.position" placeholder="请选择">
        ...
        <el-form-item label="排序" sort prop="link" sortable>
...
<script>
import { listAd, createAd, updateAd, deleteAd,readAd } from '@/api/ad'
