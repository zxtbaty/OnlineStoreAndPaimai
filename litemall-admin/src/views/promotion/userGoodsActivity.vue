...
<script>
import { listUserGoodsOrders,createUserGoodsOrders,editUserGoodsOrders,deleteUserGoodsOrders } from '@/api/userGoodsOrder'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listUserGoodsOrders(this.listQuery).then(response => {
    ...
    handleDownload() {
      ...
      listUserGoodsOrders(this.listQuery)
        .then(response => {
          ...
          import('@/vendor/Export2Excel').then(excel => {
            ...
            const filterVal = ['name', 'userNickname', 'orderId', 'orderSn','userPhone', 'addTime', 'goodsSn', 'goodsName', 'goodsProductSpecifications',
              'sourcePrice','userPrice', 'beginDate', 'endDate']
