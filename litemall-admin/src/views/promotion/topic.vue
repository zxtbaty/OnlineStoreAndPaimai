  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="专题详情" prop="content">
        <template slot-scope="scope">
          <el-dialog :visible.sync="contentDialogVisible" title="专题详情" :close-on-click-modal="false">
...
<script>
import { listTopic, createTopic, updateTopic, deleteTopic,readTopic } from '@/api/topic'
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      readTopic(this.dataForm.id).then(
        (response)=>{
