<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.seckillName" clearable class="filter-item" style="width: 110px;" placeholder="活动名称"/>
...
<script>
import { listSeckillOrders,createSeckillOrder,editSeckillOrder,deleteSeckillOrder } from '@/api/seckillorder'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listSeckillOrders(this.listQuery).then(response => {
    ...
    handleDownload() {
      ...
      listSeckillOrders(this.listQuery)
        .then(response => {
          ...
          import('@/vendor/Export2Excel').then(excel => {
            ...
            const filterVal = ['name', 'userNickname', 'orderId', 'orderSn','userPhone', 'addTime', 'goodsSn', 'goodsName', 'goodsProductSpecifications',
              'sourcePrice','seckillPrice', 'seckillBeginDate', 'seckillEndDate']
