...
<!--        </el-form-item>-->
        ...
        <el-form-item label="专栏/品牌">
          <el-select clearable v-model="goods.brandId">
    ...
    <el-card class="box-card">
      ...
      <el-dialog :visible.sync="specVisiable" title="设置规格" :close-on-click-modal="false">
        <el-form
          ref="specForm"
          :rules="rules"
          :model="specForm"
    ...
    <el-card class="box-card">
      ...
      <el-table :data="products">
        ...
        <el-table-column property="priceDesc" width="100" label="其它售价"/>
      ...
      <el-dialog :visible.sync="productVisiable" title="设置货品" :close-on-click-modal="false">
        <el-form
          ...
          <el-form-item label="货品售价" prop="price">
            <el-radio-group v-model="productForm.priceMethod">
              <el-radio :label="'固定单价'" :value="'固定单价'">固定单价</el-radio>
              <el-radio :label="'描述单价'" :value="'描述单价'">描述单价</el-radio>
            </el-radio-group>
          </el-form-item>
          <el-form-item label="货品售价" prop="price">
          ...
          <el-form-item label="描述价格" prop="priceDesc">
            <el-input v-model="productForm.priceDesc"/>
          </el-form-item>
    ...
    <el-card class="box-card">
      ...
      <el-dialog :visible.sync="attributeVisiable" title="设置商品参数" :close-on-click-modal="false">
        <el-form
          ref="attributeForm"
          :model="attributeForm"
          status-icon
