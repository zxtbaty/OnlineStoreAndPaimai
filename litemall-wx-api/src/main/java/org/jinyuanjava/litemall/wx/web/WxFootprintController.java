...
@Validated
@Api(description = "微信前端/用户访问足迹服务:/wx/footprint")
public class WxFootprintController {
    ...
    public Object list(@LoginUser Integer userId,
        ...
        for (LitemallFootprint footprint : footprintList) {
            ...
            c.put("wxNickname", footprint.getWxNickname());
            c.put("weixinOpenid", footprint.getWeixinOpenid());
            c.put("crmId", footprint.getCrmId());
            c.put("goodsSn", footprint.getGoodsSn());
            c.put("goodsName", footprint.getGoodsName());
