...
import org.jinyuanjava.litemall.wx.vo.CouponVo;
import org.jinyuanjava.litemall.wx.util.WxResponseCode;
...
@Validated
@Api(description = "微信前端/优惠券:/wx/coupon")
public class WxCouponController {
    ...
    public Object list(@RequestParam(defaultValue = "1") Integer page,
        ...
        List<LitemallCoupon> couponList = couponService.queryList(page, limit, sort);
