...
```
org.apache.ibatis.binding.BindingException: Invalid bound statement (not found): org.jinyuanjava.litemall.db.dao.XXXX
```
...
The error may exist in org/jinyuanjava/litemall/db/dao/LitemallSystemMapper.xml
The error may involve org.jinyuanjava.litemall.db.dao.LitemallSystemMapper.selectByExample-Inline
