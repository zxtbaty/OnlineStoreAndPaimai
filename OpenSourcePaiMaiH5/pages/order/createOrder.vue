...
<!-- 		<view class="yt-list">
		...
		<view class="yt-list">
			...
			<view class="yt-list-cell b-b uni-list-cell uni-list-cell-pd">
				<view class=" cell-tit clamp uni-list-cell-db">积分抵现</view>
				<view>
					<text class="cell-tip">3500</text>
					<switch style="transform:scale(0.7)" checked />
					<text class="cell-tip red">-￥35</text>
				</view>
