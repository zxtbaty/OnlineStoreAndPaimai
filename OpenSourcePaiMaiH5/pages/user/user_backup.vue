    ...
    <view class="container">  
		...
		>
			...
			<view class="history-section icon">
			    ...
			    <list-cell icon="icon-iconfontweixin" iconColor="#e07472" title="我的保证金" tips="保证金自动解冻归还"></list-cell>
			    <list-cell icon="icon-iconfontweixin" iconColor="#e07472" title="我的拍卖" ></list-cell>			
				<list-cell icon="icon-iconfontweixin" iconColor="#e07472" title="我的定制" ></list-cell>	
				<list-cell icon="icon-iconfontweixin" iconColor="#e07472" title="客服与帮助" ></list-cell>	
