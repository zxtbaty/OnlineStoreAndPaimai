		...
		<view class="user-section">
			...
			<view class="user-info-box">
				<view class="portrait-box">
					<image class="portrait" :src="userInfo.avatar || '/static/missing-face.png'" @click="navToLogin"></image>
				</view>
				<view class="info-box">
		...
		<view class="cover-container" :style="[{
		 ...
		 @touchstart="coverTouchstart" @touchmove="coverTouchmove" @touchend="coverTouchend">
			...
			<view class="tj-sction">
				...
				<view class="tj-item" @click="navTo('/pages/user/myCharge')">
					<text class="num" v-if="userInfo.chargeRemainMoney==null">0</text>
					<text class="num" v-if="userInfo.chargeRemainMoney!=null">{{userInfo.chargeRemainMoney}}</text>
					<text>保证金</text>
				</view>
				<view class="tj-item">
...
<!-- 				<view class="sec-header">
			    ...
			    <list-cell icon="icon-iconfontweixin" iconColor="#e07472" title="我的保证金"
				 tips="保证金自动解冻归还" @eventClick="navTo('/pages/user/myCharge')"></list-cell>
			    <list-cell icon="icon-iconfontweixin" iconColor="#e07472" title="我的出价"
				 @eventClick="navTo('/pages/user/myOffer')"></list-cell>			
				...
				that.$http({ //调用接口
					...
					if (result.errno == 0) {
						...
						if(userInfo.bonus!=null){
							that.bonus = userInfo.remainBonus;
						} else{
							that.bonus =0
						}
