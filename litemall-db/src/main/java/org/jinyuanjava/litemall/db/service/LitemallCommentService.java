...
import org.jinyuanjava.litemall.db.dao.LitemallCommentMapper;
import org.jinyuanjava.litemall.db.domain.LitemallComment;
import org.jinyuanjava.litemall.db.domain.LitemallCommentExample;
...
public class LitemallCommentService {
    ...
    public List<LitemallComment> querySelective(String userId, String valueId, Integer page, Integer size, String sort) {
        LitemallCommentExample example = new LitemallCommentExample();
