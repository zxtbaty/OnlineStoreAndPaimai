...
import org.jinyuanjava.litemall.db.dao.LitemallCouponMapper;
import org.jinyuanjava.litemall.db.dao.LitemallCouponUserMapper;
import org.jinyuanjava.litemall.db.domain.*;
import org.jinyuanjava.litemall.db.domain.LitemallCoupon.Column;
...
public class LitemallCouponService {
     ...
     * @return
     */
    public List<LitemallCoupon> queryList(int offset, int limit, String sort) {
        return queryList(LitemallCouponExample.newAndCreateCriteria(), offset, limit, sort);
    }
    ...
    public List<LitemallCoupon> queryList(LitemallCouponExample.Criteria criteria, int offset, int limit, String sort) {
        ...
        criteria.example().setOrderByClause(sort);
    ...
    public List<LitemallCoupon> queryAvailableList(Integer userId, int offset, int limit) {
        ...
        return queryList(c, offset, limit, "add_time");
    }

    public List<LitemallCoupon> queryList(int offset, int limit) {
        return queryList(offset, limit, "add_time");
    }
    ...
    public List<LitemallCoupon> querySelective(String name, Short type, Short status, Integer page, Integer limit, String sort) {
        LitemallCouponExample example = new LitemallCouponExample();
