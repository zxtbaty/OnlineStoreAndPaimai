...
import org.jinyuanjava.litemall.db.dao.LitemallLogMapper;
import org.jinyuanjava.litemall.db.domain.LitemallLog;
import org.jinyuanjava.litemall.db.domain.LitemallLogExample;
...
public class LitemallLogService {
    ...
    public List<LitemallLog> querySelective(String name, Integer page, Integer size, String sort) {
