...
import org.jinyuanjava.litemall.db.dao.LitemallKeywordMapper;
import org.jinyuanjava.litemall.db.domain.LitemallKeyword;
import org.jinyuanjava.litemall.db.domain.LitemallKeywordExample;
...
public class LitemallKeywordService {
    ...
    public List<LitemallKeyword> querySelective(String keyword, String url, Integer page, Integer limit, String sort) {
        LitemallKeywordExample example = new LitemallKeywordExample();
