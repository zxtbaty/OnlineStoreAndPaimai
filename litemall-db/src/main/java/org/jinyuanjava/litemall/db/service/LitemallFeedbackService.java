...
import org.jinyuanjava.litemall.db.dao.LitemallFeedbackMapper;
import org.jinyuanjava.litemall.db.domain.LitemallFeedback;
import org.jinyuanjava.litemall.db.domain.LitemallFeedbackExample;
...
public class LitemallFeedbackService {
    ...
    public List<LitemallFeedback> querySelective(Integer userId, String username, Integer page, Integer limit, String sort) {
