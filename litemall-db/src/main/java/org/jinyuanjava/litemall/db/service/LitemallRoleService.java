...
import org.jinyuanjava.litemall.db.dao.LitemallRoleMapper;
import org.jinyuanjava.litemall.db.domain.LitemallRole;
import org.jinyuanjava.litemall.db.domain.LitemallRoleExample;
...
public class LitemallRoleService {
    ...
    public List<LitemallRole> querySelective(String name, Integer page, Integer limit, String sort) {
        LitemallRoleExample example = new LitemallRoleExample();
