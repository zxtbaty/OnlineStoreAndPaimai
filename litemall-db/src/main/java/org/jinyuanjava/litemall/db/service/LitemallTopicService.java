...
import org.jinyuanjava.litemall.db.dao.LitemallTopicMapper;
import org.jinyuanjava.litemall.db.domain.LitemallTopic;
import org.jinyuanjava.litemall.db.domain.LitemallTopic.Column;
import org.jinyuanjava.litemall.db.domain.LitemallTopicExample;
...
public class LitemallTopicService {
    ...
    public List<LitemallTopic> queryList(int offset, int limit, String sort) {
    ...
    public List<LitemallTopic> querySelective(String title, String subtitle, Integer page, Integer limit, String sort) {
        LitemallTopicExample example = new LitemallTopicExample();
